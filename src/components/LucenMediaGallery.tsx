...
const galleryItems = [
  {
    ...
    type: 'video' as const,
    src: '/media/scale-your-message.mp4',
  ...
  },
  {
    ...
    type: 'video' as const,
    src: '/media/captivate-passersby.mp4',
  ...
  },
  {
    ...
    type: 'video' as const,
    src: '/media/give-your-outdoor-advertising.mp4',
    href: '/industries/events-exhibitions',
    span: 'md:col-span-4',
  },
  {
    title: 'Airline Experience',
    subtitle: 'Lounge & gate immersion',
    type: 'image' as const,
    src: '/media/holo-plane.png',
    href: '/industries/airlines',
    span: 'md:col-span-6',
  },
  {
    title: 'Global Network',
    subtitle: 'Lucen interface system',
    type: 'image' as const,
    src: '/media/holo-globe.png',
    href: '/about',
    span: 'md:col-span-6',
  },
];
